...
def connectNetwork():
    ...
    hidden1_neurons[4].setInput(input_neurons[1])
    hidden1_neurons[4].setInput(input_neurons[3])
    #hidden1_neurons[4].setInput(input_neurons[2])
    #hidden1_neurons[4].setInput(input_neurons[0])

    hidden1_neurons[5].setInput(input_neurons[2])
    hidden1_neurons[5].setInput(input_neurons[3])
    #hidden1_neurons[5].setInput(input_neurons[1])
    #hidden1_neurons[5].setInput(input_neurons[0])
    ...
    #hidden2_neurons[0].setInput(hidden1_neurons[4])
    #hidden2_neurons[0].setInput(hidden1_neurons[5])

    hidden2_neurons[1].setInput(hidden1_neurons[1])
    hidden2_neurons[1].setInput(hidden1_neurons[4])
    ...
    #hidden2_neurons[1].setInput(hidden1_neurons[5])

    hidden2_neurons[2].setInput(hidden1_neurons[2])
    hidden2_neurons[2].setInput(hidden1_neurons[5])
    ...
    #hidden2_neurons[2].setInput(hidden1_neurons[4])
...
def training(cycle):
    for i in range (cycle):
        ...
        num=numpy.random.randint(low=0,high=35)
